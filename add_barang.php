...
$char = "IDWARE";    // inisial kode barcode terdiri atas 6 karakter, ini bisa kamu ganti sesuai kebutuhan
        ...
        <div class="row">
           <div class="form-group col-md-6 col-xs-12" >
                 ...
                 <div class="form-group col-md-3 col-xs-6" >
                  <div class="col-sm-9">
                    <div class="col-xs-1" align="left">
          <button type="button" class="btn btn-info btn-xs" onclick="sync();">Barcode dr system</button>
        </div>
                  </div>
                </div>
        ...
        $result=mysqli_query($conn,$sql);
          ...
          if($chmod >= 3 || $_SESSION['jabatan'] == 'admin'){
             move_uploaded_file($tmp, $avatar);
                  $sql1 = "update $tabeldatabase set nama='$nama', hargabeli='$hargabeli', hargajual='$hargajual', kategori='$kategori', brand='$brand', keterangan='$keterangan', barcode='$barcode', avatar='$avatar' where kode='$kode'";
          ...
          move_uploaded_file($tmp, $avatar);
            $sql2 = "insert into $tabeldatabase values( '$kode','$nama','$hargabeli','$hargajual','$keterangan','$kategori','','','','','$barcode','$brand','$avatar','')";
