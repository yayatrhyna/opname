...
?>
  ...
  ?>
         ...
         <div class="form-group">
                  <label for="menu5" class="col-sm-3 control-label">Menu Barcode</label>
                  <div class="col-sm-9">
        ...
        <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="hidden" class="form-control" id="menu6" name="menu6" placeholder="Masukkan Hak Akses" value="5" maxlength="1">
                  </div>
                </div>

        <div class="form-group">
                  <label for="menu7" class="col-sm-3 control-label"></label>
                  <div class="col-sm-9">
                    <input type="hidden" class="form-control" id="menu7" name="menu7" placeholder="Masukkan Hak Akses" value="5" maxlength="1">
                  </div>
                </div>
                ...
                <div class="form-group">
                          <label for="menu9" class="col-sm-3 control-label"></label>
                          <div class="col-sm-9">
