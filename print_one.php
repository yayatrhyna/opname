    ...
    <td colspan="4" style=" text-align:center; border-bottom:double 4px #000; padding-bottom:5px;width:240px;"><?php echo $notelp;?></td>
        ...
        <tr >
          ...
          while ($fill = mysqli_fetch_assoc($hasil)){
            ...
            <tr>
              ...
              <td style="width:43.2px;"><?php  echo mysqli_real_escape_string($conn, $fill['jumlah']); ?> x</td>
              <td style="width:48px;" align="right"><?php  echo number_format(($fill['harga']), $decimal, $a_decimal, $thousand).',-'; ?></td>
        ...
        <tr>
         ...
         <tr>
          ...
          <td style="width:72px;" colspan="2" align="right"><?php echo number_format($diskon, $decimal, $a_decimal, $thousand).',-';?></td>
          </tr>
        <?php } ?>
          <tr class="siv">
          <td colspan="5" style="width:228px;">
        ...
        <td style="width:12px;">(-) </td>
         ...
         <tr>
          <td colspan="3" style="width:120px;"></td>
          <td style="width:48px;">Total</td> <?php $totbayar = $total - $diskon ?>
          <td style="width:72px;" colspan="2" align="right"><?php echo number_format($totbayar, $decimal, $a_decimal, $thousand).',-';?></td>
          </tr>
        <tr>
          <td colspan="3" style="width:120px;"></td>
