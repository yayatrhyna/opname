  ...
  <!-- KONTEN BODY AWAL -->
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Stok Barang Hasil Retur Penjualan</h3>
...
<tr>
          ...
          <?php echo "<a href='#myModal' class='btn btn-danger btn-xs' id='custId' data-toggle='modal' data-id=".$fill['kode']."><strong>Pindah Ke Gudang</strong></a>"; ?>
           <?php } else {}?>
